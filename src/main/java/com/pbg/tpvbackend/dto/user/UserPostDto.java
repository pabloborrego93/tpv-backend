...
public class UserPostDto {
	...
	public UserPostDto(
			...
			@NotNull(message = "Confirm password can not be null") @NotBlank(message = "Confirm password can not be blank") @Size(min = 8, max = 32, message = "Confirm password length must be between 8 and 32 chars") String confirmPassword) {
		super();
